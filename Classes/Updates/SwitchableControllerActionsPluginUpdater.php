...
final class SwitchableControllerActionsPluginUpdater implements UpgradeWizardInterface
{
  private const MIGRATION_SETTINGS = [
    [
      ...
      'targetListType' => 'slubevents_eventlist',
    ],
    [
      'sourceListType' => 'slubevents_eventlist',
      'switchableControllerActions' => 'Event->listUpcoming',
      'targetListType' => 'slubevents_eventlistupcoming',
    ],
    [
      'sourceListType' => 'slubevents_eventlist',
      'switchableControllerActions' => 'Event->listMonth',
      'targetListType' => 'slubevents_eventlistmonth',
    ],
    [
      'sourceListType' => 'slubevents_eventlist',
      'switchableControllerActions' => 'Event->show;Event->showNotFound',
      'targetListType' => 'slubevents_eventshow',
    ],
    [
      'sourceListType' => 'slubevents_eventuserpanel',
      'switchableControllerActions' => 'Event->listOwn;Event->show',
      'targetListType' => 'slubevents_eventuserpanel',
    ],
    [
      'sourceListType' => 'slubevents_eventsubscribe',
      'switchableControllerActions' => 'Subscriber->delete;Subscriber->eventNotFound;Subscriber->subscriberNotFound;',
      'targetListType' => 'slubevents_eventsubscribedelete',
    ],
    [
      'sourceListType' => 'slubevents_eventsubscribe',
      'switchableControllerActions' => 'Subscriber->new;Subscriber->create;Subscriber->eventNotFound;',
      'targetListType' => 'slubevents_eventsubscribecreate',
    ],
    [
      'sourceListType' => 'slubevents_eventgeniusbar',
      'switchableControllerActions' => 'Category->contactList;Category->list;Category->gbList',
      'targetListType' => 'slubevents_eventgeniusbarcontactlist',
    ],
    [
      'sourceListType' => 'slubevents_eventgeniusbar',
      'switchableControllerActions' => 'Category->list;Category->gbList;Category->contactList',
      'targetListType' => 'slubevents_eventgeniusbarcategorylist',
    ]
  ];
  ...
  {
      return 'EXT:slub_events: Migrates plugin and settings of existing SlubEvents plugins using switchableControllerActions';
  }

  public function getDescription(): string
  {
    $description = 'The old SlubEvents plugin using switchableControllerActions has been split into ' . count(self::MIGRATION_SETTINGS) .' separate plugins. ';
    $description .= 'This update wizard migrates all existing plugin settings and changes the Plugin (list_type) ';

    return $description . 'to use the new plugins available.';
  }
